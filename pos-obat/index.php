    ...
    <div class="min-h-screen lg:grid lg:grid-cols-[260px_1fr]">
        ...
        <main class="p-4 sm:p-6 lg:p-8">
            ...
            <div class="grid gap-6 lg:grid-cols-3">
                <section class="lg:col-span-2 bg-white p-6 border-t-4 border-cyan-500">
                    ...
                    <div class="grid gap-0 sm:grid-cols-2">
                        <?php foreach ($items as $no => $item): ?>
                            <article
                                class="border-2 border-slate-200 p-4 transition hover:border-cyan-500 hover:bg-cyan-50">
                                ...
                                <div class="mt-3 flex items-center justify-between">
                                    ...
                                    <form method="post">
                                        ...
                                        <button type="submit" name="add-cart"
                                            class="bg-cyan-600 px-3 py-1.5 text-sm font-bold text-white hover:bg-cyan-700">
                                            Tambah
                                        </button>
                                    </form>
                                </div>
                ...
                <section class="bg-slate-900 p-6 text-white">
                    <h3 class="text-lg font-bold">Keranjang</h3>
                    <?php if ($submitError): ?>
                        <p class="mt-2 border-l-4 border-rose-500 bg-rose-900/30 px-3 py-2 text-sm text-rose-300">
                            Keranjang masih kosong.
                        </p>
                    <?php endif; ?>
                    <div class="mt-4 space-y-3">
                        <?php foreach ($carts as $no => $cart): ?>
                            <div class="border-l-4 border-cyan-400 bg-slate-800 p-3">
                                    ...
                                    <div class="inline-flex items-center gap-2">
                                        <form method="post">
                                            ...
                                            <button type="submit" name="reduce-cart"
                                                class="border-2 border-slate-600 bg-slate-700 px-2 text-white hover:bg-slate-600">-</button>
                                        </form>
                    ...
                    <div class="mt-6 space-y-2 border-t-2 border-slate-700 pt-4 text-sm">
                        <div class="flex justify-between text-base font-bold">
                            <span>Total</span>
                            <span class="text-cyan-400">Rp <?= $trs->getTotalHarga() ?></span>
                        </div>
                    </div>

                    <form method="post">
                        <button type="submit" name="submit-transaksi"
                            class="mt-5 w-full bg-cyan-600 px-4 py-3 font-bold text-white transition hover:bg-cyan-700">
                            Submit Transaksi
                        </button>
                    </form>
                </section>
