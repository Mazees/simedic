...
$code = preg_replace('/[^0-9]/', '', (string) $rawCode);
if ($code === '') {
    $code = '404';
}
...
<body class="min-h-full bg-slate-50 font-sans text-slate-900 e-<?php echo htmlspecialchars($code, ENT_QUOTES, 'UTF-8'); ?>">
        ...
        <div class="w-full max-w-lg text-center animate-fadeIn">
            ...
            <div class="flex justify-center mb-8">
                <div class="animate-float animate-scalePop flex h-24 w-24 items-center justify-center rounded-3xl shadow-xl"
                    ...
                    <?php if ($code === '403'): ?>
                    <!-- Padlock -->
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" style="color:var(--a)">
            ...
            <!-- Badge -->
            <span class="inline-flex items-center gap-2 rounded-full px-4 py-1 text-xs font-bold uppercase tracking-widest"
